...
print('Salario Bruto: ('+ str(valorPorHora)+ '*'+ str(quantidadeHoras)+ '): R$'+str(salarioBruto))
print('(-) IR ('+ str(aliquotaIR)+ '%): R$'+ str(valorIR))
print('(-) Sindicato ( 3 %): R$'+ str(valorSindicato))
print('FGTS ( 11 %): R$'+ str(valorFGTS))
print('Total de Descontos: R$'+ str(totalDescontos))
print('Salario Liquido: R$'+ str(salarioLiquido))